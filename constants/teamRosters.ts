...
export const officialSquadsNotice = {
  ...
  text: "FIFA 已确认 48 支参赛队的最终名单；本地数据已覆盖全部球队，并已在 2026-06-05 追加核对墨西哥、加拿大、美国、韩国、澳大利亚、巴拉圭、奥地利、南非、捷克等队的官方或可信名单与号码信息。"
};
...
export const teamRosters: Record<string, TeamRoster> = {
  ...
  RSA: {
    ...
    source: "FIFA squad list via SuperSport",
    sourceUrl: "https://beta.supersport.com/football/fifa-world-cup/news/7e7eaf93-2399-4612-b743-36aaceb258e4/fifa-world-cup-2026-squads-confirmed",
    note: "按 FIFA 2026-06-03 完整名单页复核南非 26 人。移出 Ricardo Goss、Grant Kekana、Siyanda Xulu、Terrence Mashego、Sphephelo Sithole、Bathusi Aubaas、Thalente Mbatha、Jayden Adams、Themba Zwane、Zakhele Lepasa、Iqraam Rayners、Mihlali Mayambela、Sibongiseni Mthethwa；补入 Trevor Doornbusch、Rushwin Dortley、Fawaaz Basadien、Samukelo Kabini、Siyabonga Ngezana、Mbekezeli Mbokazi、Aphiwe Baliti、Siphephelo Mbule、Mduduzi Shabalala、Mohau Nkota、Patrick Maswanganyi、Neo Maema、Ashley Cupido。因库拉索名单已有同名 Trevor Doornbusch，南非条目使用 Trevor Doornbusch (South Africa) 作为本地 key 避免串档。当前未找到完整可靠号码源，号码暂标为待核实。",
    players: [
      ...
      { number: "待核实", name: "Trevor Doornbusch (South Africa)", chineseName: "特雷弗·多恩布施", position: "门将" },
      ...
      { number: "待核实", name: "Rushwin Dortley", chineseName: "拉什温·多特利", position: "后卫" },
      { number: "待核实", name: "Fawaaz Basadien", chineseName: "法瓦兹·巴萨迪恩", position: "后卫" },
      { number: "待核实", name: "Aubrey Modiba", chineseName: "奥布里·莫迪巴", position: "后卫" },
      { number: "待核实", name: "Samukelo Kabini", chineseName: "萨穆凯洛·卡比尼", position: "后卫" },
      { number: "待核实", name: "Siyabonga Ngezana", chineseName: "西亚邦加·恩格扎纳", position: "后卫" },
      { number: "待核实", name: "Mbekezeli Mbokazi", chineseName: "姆贝凯泽利·姆博卡齐", position: "后卫" },
      { number: "待核实", name: "Aphiwe Baliti", chineseName: "阿菲韦·巴利蒂", position: "后卫" },
      { number: "待核实", name: "Teboho Mokoena", chineseName: "特博霍·莫科纳", position: "中场" },
      { number: "待核实", name: "Siphephelo Mbule", chineseName: "西费费洛·姆布莱", position: "中场" },
      { number: "待核实", name: "Mduduzi Shabalala", chineseName: "姆杜杜齐·沙巴拉拉", position: "中场" },
      { number: "待核实", name: "Mohau Nkota", chineseName: "莫豪·恩科塔", position: "中场" },
      { number: "待核实", name: "Patrick Maswanganyi", chineseName: "帕特里克·马斯旺甘伊", position: "中场" },
      { number: "待核实", name: "Neo Maema", chineseName: "内奥·马埃马", position: "中场" },
      ...
      { number: "待核实", name: "Ashley Cupido", chineseName: "阿什利·库皮多", position: "前锋" }
    ]
  },
  KOR: {
    teamCode: "KOR",
    ...
    confirmed: true,
    publishedDate: "2026-06-03",
    source: "FIFA squad list via SuperSport / AFC",
    sourceUrl: "https://beta.supersport.com/football/fifa-world-cup/news/7e7eaf93-2399-4612-b743-36aaceb258e4/fifa-world-cup-2026-squads-confirmed",
    note: "按 FIFA 2026-06-03 完整名单页复核韩国 26 人，并保留 AFC 2026-06-02 确认的 Cho Wi-je 递补 Yu-Min Cho。移出 Kim Young-gwon、Jung Seung-hyun、Kim Moon-hwan、Lee Myung-jae、Park Yong-woo、Hong Hyun-seok、Paik Seung-ho、Jeong Woo-yeong、Yang Hyun-jun、Joo Min-kyu、Um Won-sang、Lee Han-beom 等旧名单成员；补入 Tae-Hyon Kim、Jin-Seob Park、Jens Castrop、Ki-Hyuk Lee、Tae-Seok Lee、Jin-Gyu Kim、Ji-Sung Eom、Dong-Gyeong Lee、Sang-Bin Jeong、Ju-Hun Song、Sang-Hyeok Park、Min-Kyu Joo。当前未找到完整可靠号码源，除已可靠公开确认的核心号码外继续待核实。",
    players: [
      ...
      { number: "待核实", name: "Tae-Hyon Kim", chineseName: "金泰贤", position: "后卫" },
      { number: "待核实", name: "Jin-Seob Park", chineseName: "朴镇燮", position: "后卫" },
      { number: "待核实", name: "Ju-Hun Song", chineseName: "宋株薰", position: "后卫" },
      { number: "待核实", name: "Sang-Hyeok Park", chineseName: "朴相赫", position: "后卫" },
      { number: "待核实", name: "Cho Wi-je", chineseName: "赵威济", position: "后卫" },
      ...
      { number: "待核实", name: "Jens Castrop", chineseName: "延斯·卡斯特罗普", position: "中场" },
      { number: "待核实", name: "Ki-Hyuk Lee", chineseName: "李基赫", position: "中场" },
      { number: "待核实", name: "Tae-Seok Lee", chineseName: "李泰锡", position: "中场" },
      { number: "待核实", name: "Jin-Gyu Kim", chineseName: "金镇圭", position: "中场" },
      { number: "待核实", name: "Ji-Sung Eom", chineseName: "严智星", position: "中场" },
      { number: "待核实", name: "Dong-Gyeong Lee", chineseName: "李东炅", position: "中场" },
      ...
      { number: "待核实", name: "Sang-Bin Jeong", chineseName: "郑相彬", position: "前锋" },
      { number: "待核实", name: "Min-Kyu Joo", chineseName: "周敏圭", position: "前锋" }
    ]
  },
  CZE: {
    teamCode: "CZE",
    ...
    source: "FIFA squad list via SuperSport",
    sourceUrl: "https://beta.supersport.com/football/fifa-world-cup/news/7e7eaf93-2399-4612-b743-36aaceb258e4/fifa-world-cup-2026-squads-confirmed",
    note: "按 FIFA 2026-06-03 完整名单页复核捷克 26 人。移出 Vitezslav Jaros、Jaroslav Zeleny、David Jurasek、Michal Sadilek、Antonin Barak、Mojmir Chytil、Jan Kuchta、Ondrej Lingr、Lukas Cerv；补入 Lukas Hornicek、Lukas Hejda、David Zeleny、Tomas Vlcek、Tomas Wiesner、Vaclav Jemelka、Michal Beran、David Pavelka、David Pech。当前未找到完整可靠号码源，号码暂标为待核实。",
    players: [
      ...
      { number: "待核实", name: "Lukas Hornicek", chineseName: "卢卡什·霍尔尼切克", position: "门将" },
      ...
      { number: "待核实", name: "Lukas Hejda", chineseName: "卢卡什·海伊达", position: "后卫" },
      { number: "待核实", name: "David Zeleny", chineseName: "大卫·泽莱尼", position: "后卫" },
      { number: "待核实", name: "Tomas Vlcek", chineseName: "托马什·弗尔切克", position: "后卫" },
      { number: "待核实", name: "Tomas Wiesner", chineseName: "托马什·维斯纳", position: "后卫" },
      { number: "待核实", name: "Vaclav Jemelka", chineseName: "瓦茨拉夫·耶梅尔卡", position: "后卫" },
      ...
      { number: "待核实", name: "Michal Beran", chineseName: "米哈尔·贝兰", position: "中场" },
      { number: "待核实", name: "David Pavelka", chineseName: "大卫·帕维尔卡", position: "中场" },
      { number: "待核实", name: "David Pech", chineseName: "大卫·佩赫", position: "中场" },
  ...
  CAN: {
    ...
    note: "Canada Soccer 于 2026-05-29 公布最终 26 人名单，并附带球员俱乐部与年龄信息；仍未找到该队完整官方号码公告，号码继续保留待核实。",
    players: [
  ...
  USA: {
    ...
    source: "U.S. Soccer",
    sourceUrl: "https://www.ussoccer.com/teams/usmnt/roster",
    note: "美国队名单由 U.S. Soccer 于 2026-05-26 公布，并在官方 roster page 展示当前 26 人号码与出场数据。",
    players: [
      ...
      { number: 11, name: "Brenden Aaronson", chineseName: "布伦登·阿伦森", position: "中场" },
      ...
      { number: 10, name: "Christian Pulisic", chineseName: "克里斯蒂安·普利西奇", position: "中场" },
      { number: 7, name: "Gio Reyna", chineseName: "吉奥·雷纳", position: "中场" },
      ...
      { number: 21, name: "Tim Weah", chineseName: "蒂姆·维阿", position: "中场" },
      { number: 26, name: "Alejandro Zendejas", chineseName: "亚历杭德罗·森德哈斯", position: "中场" },
  ...
  PAR: {
    ...
    publishedDate: "2026-06-02",
    source: "FIFA",
    sourceUrl: "https://www.fifa.com/en/tournaments/mens/worldcup/canadamexicousa2026/articles/paraguay-squad-announcement-gustavo-alfaro",
    note: "巴拉圭最终 26 人名单已按 FIFA 2026-06-01 单队公告复核；Orlando Gill、Roberto Fernandez、Gaston Olveira、Gustavo Velazquez、Jose Canale、Alexandro Maidana、Mauricio Magalhaes、Alejandro Gamarra、Gustavo Caballero、Gabriel Avalos 等补入，Carlos Coronel、Juan Espinola、Alan Benitez、Blas Riveros、Juan Jose Caceres 等移出。FIFA 未提供完整号码，号码暂标为待核实。",
    players: [
      { number: "待核实", name: "Orlando Gill", chineseName: "奥兰多·吉尔", position: "门将" },
      { number: "待核实", name: "Roberto Fernandez", chineseName: "罗伯托·费尔南德斯", position: "门将" },
      { number: "待核实", name: "Gaston Olveira", chineseName: "加斯顿·奥尔韦拉", position: "门将" },
      { number: "待核实", name: "Juan Caceres", chineseName: "胡安·卡塞雷斯", position: "后卫" },
      { number: "待核实", name: "Gustavo Velazquez", chineseName: "古斯塔沃·贝拉斯克斯", position: "后卫" },
      { number: "待核实", name: "Gustavo Gomez", chineseName: "古斯塔沃·戈麦斯", position: "后卫" },
      { number: "待核实", name: "Junior Alonso", chineseName: "朱尼奥尔·阿隆索", position: "后卫" },
      { number: "待核实", name: "Jose Canale", chineseName: "何塞·卡纳莱", position: "后卫" },
      { number: "待核实", name: "Omar Alderete", chineseName: "奥马尔·阿尔德雷特", position: "后卫" },
      { number: "待核实", name: "Alexandro Maidana", chineseName: "亚历杭德罗·迈达纳", position: "后卫" },
      { number: "待核实", name: "Fabian Balbuena", chineseName: "法比安·巴尔武埃纳", position: "后卫" },
      { number: "待核实", name: "Diego Gomez", chineseName: "迭戈·戈麦斯", position: "中场" },
      { number: "待核实", name: "Mauricio Magalhaes", chineseName: "毛里西奥·马加良斯", position: "中场" },
      ...
      { number: "待核实", name: "Andres Cubas", chineseName: "安德烈斯·库巴斯", position: "中场" },
      { number: "待核实", name: "Matias Galarza", chineseName: "马蒂亚斯·加拉尔萨", position: "中场" },
      { number: "待核实", name: "Alejandro Gamarra", chineseName: "亚历杭德罗·加马拉", position: "中场" },
      { number: "待核实", name: "Gustavo Caballero", chineseName: "古斯塔沃·卡瓦列罗", position: "前锋" },
      { number: "待核实", name: "Ramon Sosa", chineseName: "拉蒙·索萨", position: "前锋" },
      { number: "待核实", name: "Alex Arce", chineseName: "亚历克斯·阿尔塞", position: "前锋" },
      { number: "待核实", name: "Isidro Pitta", chineseName: "伊西德罗·皮塔", position: "前锋" },
      { number: "待核实", name: "Gabriel Avalos", chineseName: "加布里埃尔·阿瓦洛斯", position: "前锋" },
      { number: "待核实", name: "Miguel Almiron", chineseName: "米格尔·阿尔米隆", position: "前锋" },
      { number: "待核实", name: "Julio Enciso", chineseName: "胡利奥·恩西索", position: "前锋" },
  ...
  AUS: {
    ...
    source: "FIFA official squad list / Football Australia",
    sourceUrl: "https://fdp.fifa.org/assetspublic/ce281/pdf/SquadLists-English.pdf",
    note: "澳大利亚最终 26 人名单已按 FIFA 2026-06-04 官方 squad list 与 Football Australia/Socceroos 官方公告复核；Paul Okon-Engstler、Tete Yengi 等姓名与 1-26 号码均已按 FIFA PDF 更新。",
    players: [
      { number: 1, name: "Maty Ryan", chineseName: "马蒂·瑞安", position: "门将" },
      ...
      { number: 10, name: "Ajdin Hrustic", chineseName: "艾丁·赫鲁斯蒂奇", position: "中场" },
      ...
      { number: 13, name: "Aiden O'Neill", chineseName: "艾登·奥尼尔", position: "中场" },
  ...
  AUT: {
    ...
    sourceUrl: "https://fdp.fifa.org/assetspublic/ce281/pdf/SquadLists-English.pdf",
    note: "奥地利最终名单已按 FIFA 2026-06-04 官方 squad list 复核并补齐 1-26 号码。Christoph Baumgartner 虽有伤情报道，但仍列入 FIFA 官方名单，当前不做替换。",
    players: [
      p("Patrick Pentz", "帕特里克·彭茨", "门将", 1), p("Alexander Schlager", "亚历山大·施拉格尔", "门将", 2), p("Florian Wiegele", "弗洛里安·维格勒", "门将", 3),
      p("David Affengruber", "大卫·阿芬格鲁伯", "后卫", 4), p("David Alaba", "大卫·阿拉巴", "后卫", 5), p("Kevin Danso", "凯文·丹索", "后卫", 6), p("Marco Friedl", "马尔科·弗里德尔", "后卫", 7), p("Philipp Lienhart", "菲利普·林哈特", "后卫", 8), p("Phillipp Mwene", "菲利普·姆韦内", "后卫", 9), p("Stefan Posch", "斯特凡·波施", "后卫", 10), p("Alexander Prass", "亚历山大·普拉斯", "后卫", 11), p("Michael Svoboda", "米夏埃尔·斯沃博达", "后卫", 12),
      p("Carney Chukwuemeka", "卡尼·楚克维梅卡", "中场", 13), p("Florian Grillitsch", "弗洛里安·格里利奇", "中场", 14), p("Konrad Laimer", "康拉德·莱默", "中场", 15), p("Marcel Sabitzer", "马塞尔·萨比策", "中场", 16), p("Xaver Schlager", "克萨弗·施拉格尔", "中场", 17), p("Romano Schmid", "罗马诺·施密德", "中场", 18), p("Alessandro Schopf", "亚历山德罗·舍普夫", "中场", 19), p("Nicolas Seiwald", "尼古拉斯·塞瓦尔德", "中场", 20), p("Paul Wanner", "保罗·万纳", "中场", 21), p("Patrick Wimmer", "帕特里克·维默", "中场", 22), p("Christoph Baumgartner", "克里斯托夫·鲍姆加特纳", "中场", 23),
      p("Marko Arnautovic", "马尔科·阿瑙托维奇", "前锋", 24), p("Michael Gregoritsch", "米夏埃尔·格雷戈里奇", "前锋", 25), p("Sasa Kalajdzic", "萨沙·卡拉季奇", "前锋", 26)
    ]
  },
  JOR: {
    teamCode: "JOR",
