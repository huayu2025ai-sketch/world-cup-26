...
export const teamRosters: Record<string, TeamRoster> = {
  ...
  KOR: {
    ...
    source: "AFC / FIFA",
    sourceUrl: "https://www.the-afc.com/en/national/fifa_world_cup.html/news/like-a-dream-as-cho-gets-late-korea-republic-call-up",
    note: "AFC 于 2026-06-02 确认韩国因赵佑民足底筋膜伤势改由 Cho Wi-je 递补。可靠公开来源仍仅能确认孙兴慜7号、李刚仁19号、金玟哉4号、吴贤揆18号，其余号码待核实。",
    players: [
