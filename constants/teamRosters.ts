...
export const teamRosters: Record<string, TeamRoster> = {
  ...
  AUS: {
    ...
    source: "Football Australia / Socceroos",
    sourceUrl: "https://socceroos.com.au/news/commbank-socceroos-squad-named-fifa-world-cup-2026tm",
    note: "澳大利亚最终 26 人名单已按 Football Australia/Socceroos 官方公告和 Group D 官方球队指南复核；修正 Paul Okon-Engstler 姓名拼写，并将 Kusini Yengi 更正为 Tete Yengi。未能从可访问官方页面完整核实号码，号码继续保留待核实。",
    players: [
      { number: "待核实", name: "Maty Ryan", chineseName: "马蒂·瑞安", position: "门将" },
      ...
      { number: "待核实", name: "Paul Okon-Engstler", chineseName: "保罗·奥孔-恩斯特勒", position: "中场" },
      ...
      { number: "待核实", name: "Tete Yengi", chineseName: "特特·延吉", position: "前锋" }
    ]
  },
  TUR: {
    teamCode: "TUR",
